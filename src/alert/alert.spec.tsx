...
const TestAlert = props => {
  ...
  return (
    <TestWrapper>
      <Alert classes={classes} message="Default" />
    </TestWrapper>
  );
};
...
test("alternative alert colors", () => {
  const { getByTestId } = render(
    <TestWrapper>
      <Alert color="info" message="Test info" />
      <Alert color="success" message="Test success" />
      <Alert color="warning" variant="text" message="Test warning" />
    </TestWrapper>,
  );
  ...
  expect(getByTestId("success-alert-message")).toHaveTextContent(
    "Test success",
  );
  expect(getByTestId("warning-alert-icon")).toBeInTheDocument();
  expect(getByTestId("warning-alert-message")).toHaveTextContent(
    "Test warning",
  );
});
