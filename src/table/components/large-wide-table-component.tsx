...
export const LargeWideTableComponent: React.FC<Props> = props => {
  const {
    id,
    classes = {},
    columns,
  ...
  let columnWidthProducer = ({ index }: { index: number }) =>
    columnWidths[index];
    ...
    <div className={classNames(styles.table, classes.table)} id={id}>
      <ScrollSync>
        {({ onScroll, scrollLeft, scrollTop }) => {
          const frozenColumnsWidth = columnWidths
                ...
                <AutoSizer disableHeight>
                  {({ width }) => {
                    ...
                    const availableWidth =
                      width - frozenColumnsWidth - scrollbarSize;
                    if (nonFrozenColumnsWidth < availableWidth) {
                      const scaleFactor =
                        availableWidth / nonFrozenColumnsWidth;
