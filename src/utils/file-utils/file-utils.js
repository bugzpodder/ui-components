...
export const readFileListAsTextArray = (fileList: FileList, maxBytesPerFile?: number): Promise<Array<string>> => {
  // Convert a FileList to an Array<File>.
...
export const readFileListAsText = (fileList: FileList, maxBytes?: number): Promise<string> => {
